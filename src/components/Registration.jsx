...
if (isAuthenticated) {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      setVariant("success");
      setMessage(`Registrazione completata! Ti diamo il benvenuto, ${registerData.nome}`);
      setLoading(false);
      setTimeout(() => navigate("/login"), 800);
    } catch (error) {
      setVariant("danger");
      setMessage(error.message || "Errore nella registrazione!");
      setLoading(false);
    }
  };
          ...
          <Col md={6}>
            ...
            <Form onSubmit={handleRegister} className="login-container">
              <Form.Group className="mb-3">
                <Form.Label className="text-light">FristName</Form.Label>
                <Form.Control
